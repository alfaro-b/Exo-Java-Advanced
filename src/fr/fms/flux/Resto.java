...
/**
 * Simule la prise de commandes dans un restaurant et génère un fichier texte
 * contenant le résumé des commandes.
 */
...
public class Resto {
	...
	public static void main(String[] args) {
		...
		try (
			...
			// Contient les éléments sélectionnés pour une commande.
			...
			for (int i = 0; i < nbMenu; i++) {
				...
				// Écrit chaque élément de la commande sur une ligne.
